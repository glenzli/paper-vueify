...
export default class extends Vue {
  ...
  public tadpoles = new Array(30).fill(null).map((p) => ({
  ...
  public circle = CircleItem({ radius: 25, stroke: Stroke({ thickness: 0 }), brush: SolidBrush(Color$.ToColor('#af503d')), shadow: Shadow({ enabled: true, color: Color$.ToColor('#af503d'), blur: 10 }) });
  public parade = false;
